...
library(GPArotation)
   ...
   #Load the dataset: Select Study 1 data.csv , EDIT: i linked it to the study 1 file
saap <- read_excel("courses/daur2/daurII_students/Lesson1/Study 1 data.xlsx")

  #Subset the dataset for valid cases
saapV <- saap[saap$Valid==1,]

   #Check the dimension of the dataset
dim(saapV)

  #Subset the SAAP variables       EDIT, ze gebruiken saapV en SAAPV de hoofletters zijn niet consistent 
...
colnames(SAAPmeasure28items) <- paste("SAAP", 1:28, sep="_")
  ...
  #Choose SAAPcontent.csv Edit: i changed it to read_exel and i put in my data
SAAP.content <- read_excel("courses/daur2/daurII_students/Lesson1/Study 1 data.xlsx")
...
#Descriptive statistics for the sample
  #Age EDIT i put in an aditional ) to make sure that there are enough
